...
// Anzeigeelement für die Dauer des Loggings
...
// Empfängt Statusdaten vom Server und aktualisiert UI und Chart
socket.on("status_update", data => {
    ...
    if (now - lastUpdateTime >= 500) { // Aktualisierung nur alle 500ms
        ...
        // 🔄 Werte aktualisieren (Temperatur, PWM, etc.)
        ...
        document.getElementById("trendArrow").textContent = data.input_trend_arrow ?? "→";
        ...
        // Neue Zeile zur Logging-Tabelle hinzufügen
        ...
        // Loggingstatus prüfen und ggf. umschalten
...
// Temperaturmessdaten für Min/Max/Ø aktualisieren
...
// Aktualisiert das UI abhängig davon, ob Logging aktiv ist
function toggleLoggingStatus(active) {
    ...
    if (active) {
        ...
        statusText.innerHTML = `Protokollierung aktiv – seit <span id="logDuration">00:00:00</span>`;
...
// Fügt neue Werte in das Diagramm ein und aktualisiert die Anzeige
    ...
    chart = new Chart(ctx, {
        ...
        options: {
            ...
            scales: {
                ...
                y: { title: { display: true, text: 'Temperatur [°C]' }, beginAtZero: false },
...
// Ändert den Zoomfaktor für das Diagramm
...
// Startet eine Temperaturmessung (Min, Max, Ø)
...
// Sendet Neustartsignal an den Server (mit Bestätigung)
